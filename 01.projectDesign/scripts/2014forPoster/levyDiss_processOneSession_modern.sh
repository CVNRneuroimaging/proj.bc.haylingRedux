...
source /netusers/stowler/repos/proj.bc.levydiss/2014forPoster/levyDiss_environment.sh

herSubj="$1"
###### DEBUG: test loop for all subjects:
# for herSubj in `echo ${subjs}`; do
###### DEBUG
echo ""
echo ""
subj="${herSubj}.modern0to12s"
echo "herSubj=${herSubj}"
echo "subj=${subj}"
echo ""
echo ""
...
#legacyMaxlag=9
#legacyPolort=0
legacyStimFileA="/data/birc/Florida/STN/SUBCORT_DISS_2009/SC/AssortedScripts/stimFiles10-14-11/${herSubj}.A.CorrEx3.Uncat.1D"
legacyStimFileB="/data/birc/Florida/STN/SUBCORT_DISS_2009/SC/AssortedScripts/stimFiles10-14-11/${herSubj}.B.CorrEx3.Uncat.1D"
#### DEBUG: ####
echo ""
echo "DEBUG: stim files are"
ls -al ${legacyStimFileA} ${legacyStimFileB}
#### /DEBUG ####
...
########### DEBUG/INTERACTIVE for non-batch execution:
